...
<?php
	...
	$IdModif = $_POST['ColloneDsP'];
	
	$IdModif = str_replace(' ', '_', $IdModif); 
	...
	try{
        ...
        $sql = "ALTER TABLE `$IdTable` CHANGE `$IdCollum` `$IdModif` VARCHAR(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;";        
				$dbco->exec($sql);
